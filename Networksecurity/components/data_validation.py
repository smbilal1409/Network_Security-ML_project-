...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
                ...
                train_column_name_status=self.validate_column_names(dataframe=train_dataframe)
                if not train_column_name_status:
                    error_message = "Train dataframe does not contain same columns names.\n"
                    raise Exception(error_message)
                test_column_name_status=self.validate_column_names(dataframe=test_dataframe)
                if not train_column_name_status:
                    error_message = "Test dataframe does not contain same columns names.\n"
                    raise Exception(error_message)
                ...
                validation_status = (
                    train_column_name_status and
                    test_column_name_status and
                    train_status
                    and test_status
                    and drift_status
                )
